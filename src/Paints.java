...
public class Paints extends JPanel {
  ...
  public void paint(Graphics g1) {
    ...
    g.draw(new Rectangle2D.Double(155, 100, 50, 50));

    g.setColor(Color.RED);
    g.drawOval(100, 100, 50, 50);
    g.draw(new Ellipse2D.Double(155, 100, 50, 50));

    g.setColor(Color.BLACK);
    g.drawOval(300, 100, 50, 50);
    g.draw(new Ellipse2D.Double(355, 100, 50, 50));

    g.setColor(Color.RED);
    g.drawArc(300, 100, 50, 50, 0, 350);
    g.draw(new Arc2D.Double(355, 100, 50, 50, 0, 350, Arc2D.Double.OPEN));
...
// Paint the entire background using a GradientPaint.
    ...
    font.deriveFont(AffineTransform.getScaleInstance(3.0, 3.0));
